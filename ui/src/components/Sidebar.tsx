...
export const SECTIONS: SectionDef[] = [
  ...
  },
  {
    id: "diff",
    label: "Diff",
    glyph: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>
  },
  {
    id: "history",
    label: "History",
